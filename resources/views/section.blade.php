    ...
    <section class="banner-with-video">
        ...
        <section class="section-bg-white section-padtop-30 section-padbottom-30 clients">
            <div class="web-container-fluid">
        ...
        @php
            $requests = DB::table('requests')->where('name', '=', $row_pages->section_type)->first();
        @endphp
        @if($requests->style == 'style1')
            <div class="web-container">
                    <section class="section-bg-black section-padtop-30 section-padbottom-30 web-border-radius-5 mt-5">
                        <div class="row justify-content-center">
                            <div class="col-10 col-md-12">
                                <div class="center-content text-center">
                                    <h4 class="web-h4 text-white">{{$requests->title}}</h4>
                                    <a href="#" class="btn web-btn web-btn-blue mt-3" data-toggle="modal" data-target="#creativeModal">{{$requests->btn_label}}</a>
                                </div>
                            </div>
                        </div>
                    </section>
            </div>
        @elseif($requests->style == 'style2')
            <div class="web-container-fluid">
        ...
        @elseif($requests->style == 'style3')
    
            <section class="section-bg-dark-grey section-padtop-30 section-padbottom-30 discuss-block">
                <div class="web-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <h4 class="web-h4 text-white mb-3">{{$requests->title}}</h4>
        ...
        @elseif($requests->style == 'style4')
            ...
            <section class="section-bg-white section-padtop-30 section-padbottom-30 center-detail-block">
                <div class="web-container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="text-center">
        ...
        <section class="section-bg-white section-padtop-30 section-padbottom-30 brand-tile corporate-identity-tiles">
            <div class="web-container">
                ...
                @foreach($para_style_2 as $row_para_style_2)
                    <div class="row section-padtop-30 section-padbottom-30 @if($row_para_style_2->flex_row_reverse != NULL)flex-row-reverse @endif">
                        <div class="col-sm-6 col-md-6 align-self-center">
    ...
    <section class="section-bg-white section-padtop-15 section-padbottom-30 logo-design-boxes">
        ...
        @endphp
            ...
            <section class="design-page-center">
                <div class="web-container-fluid">
                    <div class="section-bg-dark-grey web-border-radius-5 section-padtop-30 section-padbottom-30 center-design-content">
                        <div class="web-container">
                            <div class="row">
