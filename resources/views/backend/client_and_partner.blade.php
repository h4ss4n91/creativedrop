                                        ...
                                        <div class="tab-pane active " id="account-vertical-social" role="tabpanel" aria-labelledby="account-pill-social" aria-expanded="false">
                                            <div class="media">
                                                <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                    Clients and Partners Lists
                                                    <span class="btn btn-primary btn-sm" 
                                                                data-toggle="modal" data-target="#mainMenuModel"
                                                                class="media-body mt-75"
                                                                style="border:1px solid #fff; float:right">Create Client and Partner</span>
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create Client and Partner</h5>
                                            ...
                                            <table class="table table-striped table-bordered dom-jQuery-events">
                                                ...
                                                <tbody>
                                                    @foreach($clientandpartnerimage->unique('name') as $row_clientandpartnerimage)
                                                    <tr>
                                                        <td>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="POST" action="{{url('admin/edit_client_and_partner')}}" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                        <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Edit Client and Partner</button>
