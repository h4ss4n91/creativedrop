                                                ...
                                                <form method="POST" action="{{url('admin/store_section_16')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                            <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Create Section 16 </button>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST" action="{{url('admin/edit_section_16')}}" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Edit Paragraph with Icon</button>
