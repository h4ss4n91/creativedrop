                                    ...
                                    <div class="tab-pane active" id="account-vertical-section_22" role="tabpanel" aria-labelledby="account-pill-section_22" aria-expanded="false">
                                        <div class="media">
                                            <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                Two Headings with Video or Image and Title ( Section 22 )
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create  ( Section 22 )</h5>
                                                                                                                ...
                                                                                                                <form method="POST" action="{{url('admin/store_section_22')}}" enctype="multipart/form-data">
                                                                                                                    ...
                                                                                                                    <div class="row">
                                                                                                                        ...
                                                                                                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                                                            <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Create
                                                                                                                                Section 22</button>
                                        ...
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                @foreach($section_22->unique('name') as $row_section_22)
                                                <tr>
