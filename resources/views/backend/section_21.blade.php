                                    ...
                                    <div class="tab-pane active" id="account-vertical-section_21" role="tabpanel" aria-labelledby="account-pill-section_21" aria-expanded="false">
                                        <div class="media">
                                            <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                Slider with Video ( Section 21 )
                                                <span class="btn btn-primary btn-sm" 
                                                                data-toggle="modal" data-target="#mainMenuModel"
                                                                class="media-body mt-75"
                                                                style="border:1px solid #fff; float:right">Create  ( Section 21 ) </span>
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create  ( Section 21 )</h5>
                                        ...
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#sliderWithVideoModalCenter{{$row_section_21->id}}"> <i class="fa fa-pencil-square-o admin-edit"></i></a> |
                                                        <a class="btn btn-danger btn-sm" onclick='return confirm("Are you sure? You want to delete this Record")' href="{{url('/admin/delete_slider/'.$row_section_21->id)}}"> <i class="fa fa-trash-o admin-delete text-danger"></i></a>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST" action="{{url('admin/edit_section_21')}}" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Edit Slider with Video</button>
