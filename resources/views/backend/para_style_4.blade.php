                                    ...
                                    <div class="tab-pane active" id="account-vertical-style_4" role="tabpanel" aria-labelledby="account-pill-style_4" aria-expanded="false">
                                        <div class="media">
                                            <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                Paragraph with Button ( Para Style 4 )

                                                <span class="btn btn-primary btn-sm" 
                                                                data-toggle="modal" data-target="#mainMenuModel"
                                                                class="media-body mt-75"
                                                                style="border:1px solid #fff; float:right">Create (Para Style 4) </span>
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create ( Para Style 4 ) </h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST" action="{{url('admin/edit_para_style_4')}}" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    <select name="padding_top" class="form-control">
                                                                                                        <option value="{{$row_para_style_4->padding_top}}"> {{$row_para_style_4->padding_top}} </option>
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    <select name="padding_bottom" class="form-control">
                                                                                                        <option value="{{$row_para_style_4->padding_bottom}}"> {{$row_para_style_4->padding_bottom}} </option>
                                                                                                        <option value="0"> 0 </option>
                                                                                                        <option value="30"> 30 </option>
                                                                                                        <option value="50"> 50 </option>
                                                                                                        <option value="70"> 70 </option>
                                                                                ...
                                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Edit Para Style 4</button>
