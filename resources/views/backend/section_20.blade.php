                                    ...
                                    <div class="tab-pane active" id="account-vertical-section_20" role="tabpanel" aria-labelledby="account-pill-section_20" aria-expanded="false">
                                        <div class="media">
                                            <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                Background Image with Heading ( Section 20 )
                                                <span class="btn btn-primary btn-sm" 
                                                                data-toggle="modal" data-target="#mainMenuModel"
                                                                class="media-body mt-75"
                                                                style="border:1px solid #fff; float:right">Create (Section 20) </span>
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create ( Section 20 )</h5>
                                                                                                                ...
                                                                                                                <form method="POST" action="{{url('admin/store_section_20')}}" enctype="multipart/form-data">
                                                                                                                    ...
                                                                                                                    <div class="row">
                                                                                                                        ...
                                                                                                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                                                            <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Create Section 20 </button>
                                        ...
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Top: {{$row_section_20->padding_top}} <br/>
                                                        Bottom: {{$row_section_20->padding_bottom}} <br/>
                                                    </td>
                                                    </td>
                                                    <td> <a class="btn btn-danger btn-sm" onclick='return confirm("Are you sure? You want to delete this Record")' href="{{url('admin/delete_section_20/'.$row_section_20->id)}}"><i class="fa fa-trash-o admin-delete text-danger"></i> </a>  <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#row_section_20_ModalCenter{{$row_section_20->id}}"> <i class="fa fa-pencil-square-o admin-edit"></i></a>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST" action="{{url('admin/edit_section_20')}}" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    <select name="padding_top" class="form-control">
                                                                                                        <option value="{{$row_section_20->padding_top}}"> {{$row_section_20->padding_top}} </option>
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    <select name="padding_bottom" class="form-control">
                                                                                                        <option value="{{$row_section_20->padding_bottom}}"> {{$row_section_20->padding_bottom}} </option>
                                                                                                        <option value="0"> 0 </option>
                                                                                                        <option value="30"> 30 </option>
                                                                                                        <option value="50"> 50 </option>
                                                                                                        <option value="70"> 70 </option>
                                                                                ...
                                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Edit Section 20</button>
