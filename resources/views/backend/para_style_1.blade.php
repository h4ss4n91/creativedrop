                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="tab-pane active" id="account-vertical-style_1" role="tabpanel" aria-labelledby="account-pill-style_1" aria-expanded="false">
                                        <div class="media">
                                            <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                Para Style 1 ( Paragraph Left Image Right Text)

                                                <span class="btn btn-primary btn-sm" 
                                                                data-toggle="modal" data-target="#mainMenuModel"
                                                                class="media-body mt-75"
                                                                style="border:1px solid #fff; float:right">Create ( Para style 1) </span>
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create (Para Style 1)</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST" action="{{url('admin/edit_para_style_1')}}" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Edit Para Style 1</button>
