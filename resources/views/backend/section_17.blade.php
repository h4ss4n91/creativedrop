                                        ...
                                        <div class="media">
                                            <div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75">
                                                ...
                                                <span class="btn btn-primary btn-sm" 
                                                                ...
                                                                style="border:1px solid #fff; float:right">Create ( Section 17 ) </span>
                                                                                        ...
                                                                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
																								<div class="modal-content">
																										<div class="btn btn-primary modal-header">
																											<h5 class="modal-title" id="exampleModalLongTitle">Create ( Section 17 )</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST" action="{{url('admin/edit_section_17')}}" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    <select name="padding_top" class="form-control">
                                                                                                        <option value="{{$row_section_17->padding_top}}"> {{$row_section_17->padding_top}} </option>
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    <select name="padding_bottom" class="form-control">
                                                                                                        <option value="{{$row_section_17->padding_bottom}}"> {{$row_section_17->padding_bottom}} </option>
                                                                                                        <option value="0"> 0 </option>
                                                                                                        <option value="30"> 30 </option>
                                                                                                        <option value="50"> 50 </option>
                                                                                                        <option value="70"> 70 </option>
                                                                                ...
                                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                                    <button type="submit" class="btn btn-primary btn-sm mr-sm-1 mb-1 mb-sm-0">Edit Section 17</button>
