								...
								<div class="card-body">
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
											<div style="color:#fff; border-radius:5px; background-color:#0F69C9; padding:10px;" class="media-body mt-75"> {{$row_sliders->name}} <span class="btn btn-primary btn-sm" data-toggle="modal" data-target="#mainMenuModel" class="media-body mt-75" style="border:1px solid #fff; float:right">Create new Slide for this Slider </span>
																					...
																					<div class="col-md-12">
																						<div class="form-group">
																							<div class="controls">
																								...
																								<input type="text" name="name" class="form-control" value="{{$row_sliders->name}}" id="account-username" readonly> </div>
																						</div>
																					</div>
																				</div>
																				<div class="row">
																						...
																						<div class="form-group">
																							<div class="controls">
																								...
																								<select name="padding_top" class="form-control">
																									<option value="{{$row_sliders->paddingTop}}">{{$row_sliders->paddingTop}}</option>
																						...
																						<div class="form-group">
																							<div class="controls">
																								...
																								<select name="padding_bottom" class="form-control">
																									<option value="{{$row_sliders->paddingBottom}}"> {{$row_sliders->paddingBottom}} </option>
																									<option value="0"> 0 </option>
																									<option value="30"> 30 </option>
																									<option value="50"> 50 </option>
																									<option value="70"> 70 </option>
																	...
																	<div class="container">
																		<div class="table-responsive">
																			<table class="table table-bordered">
																				...
																				<tbody id="slidertbody"> @php $content = DB::table('sliders')->where('parent','!=',NULL)->where('name','=',$row_sliders->name)->get(); @endphp @foreach($content as $row_content)
																					<tr>
