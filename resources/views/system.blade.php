        ...
        <div class="row">
          ...
          <div class="col-md-2 mb-2 mb-md-0">
            <ul class="nav nav-pills flex-column mt-md-0 mt-1">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex" id="account-pill-footer_section" data-toggle="pill" href="#account-vertical-footer_section" aria-expanded="false">
                  <!-- <i class="feather icon-list"></i> -->
              ...
              <li class="nav-item">
                <a class="nav-link d-flex" id="account-pill-logo" data-toggle="pill" href="#account-vertical-logo" aria-expanded="false">
                  <!-- <i class="feather icon-list"></i> -->
              ...
              <li class="nav-item">
                <a class="nav-link d-flex" id="account-pill-footerBottom" data-toggle="pill" href="#account-vertical-footerBottom" aria-expanded="false">
                  <!-- <i class="feather icon-list"></i> -->
              ...
              <div class="card-content">
                <div class="card-body">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade " id="account-vertical-footer_section" role="tabpanel" aria-labelledby="account-pill-footer_section" aria-expanded="false">
                      <!-- BEGIN: Content-->
                      <div class="media">
                        <div style="color:#fff; border-radius:5px; background-color:#31036e; padding:10px;" class="media-body mt-75">
                          Footer Section
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <input type="text" name="footer_section_name_1" class="form-control" id="account-username" data-validation-required-message="This username field is required">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <input type="text" name="footer_section_name_2" class="form-control" id="account-username" data-validation-required-message="This username field is required">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                <div class="controls">
                                  ...
                                  <input type="text" name="footer_section_name_3" class="form-control" id="account-username" data-validation-required-message="This username field is required">
                    ...
                    <div class="tab-pane fade " id="account-vertical-logo" role="tabpanel" aria-labelledby="account-pill-logo" aria-expanded="false">
                      <!-- BEGIN: Content-->
                      <div class="media">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            <div class="controls">
                              ...
                              <input type="file" name="logo" class="form-control" id="account-username" required data-validation-required-message="This username field is required">
                    ...
                    <div class="tab-pane fade " id="account-vertical-footerBottom" role="tabpanel" aria-labelledby="account-pill-footerBottom" aria-expanded="false">
                      <!-- BEGIN: Content-->
                      <div class="media">
