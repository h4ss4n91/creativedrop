$(document).ready(function() {
    ...
    $('#style').change(function() {
        var value = $(this).val();
        if (value == 'style1') {
            $("#style_content").html('<img style="width:100%" src="' + path + '/public/page_sections/section_15.png" />'); //this is not working
        } else if (value == 'style2') {
            $("#style_content").html('<img style="width:100%" src="' + path + '/public/page_sections/section_15_style2.png" />'); //this is not working
        } else if (value == 'style3') {
            $("#style_content").html('<img style="width:100%" src="' + path + '/public/page_sections/section_15_style3.png" />'); //this is not working
        }
